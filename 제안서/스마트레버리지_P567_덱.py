...
page(6,"투자자가 모르는 사실 ① : 방향이 없어도 원금이 깎인다 — 변동성 잠식",
     ...
     "반대로 한 방향 추세에서는 일별 복리가 단순 배수보다 유리하게 작동합니다.",
     imgs=[('lev15_arith0.png',0.45,2.10,w3),('lev15_k200flat.png',0.45+w3+g,2.10,w3),('lev15_k200trend.png',0.45+2*(w3+g),2.10,w3)],
     bigquote="방향이 아니라 '경로'가 성과를 결정합니다 — 왕복 구간에서는 제자리여도 손실이 쌓이고, 추세 구간에서는 복리가 유리합니다.",
     foot="※ KODEX 200·KODEX 레버리지 수정주가 실측 (제자리 사례 2026.02.26~04.16, 추세 사례 2026.03.31~05.29) · 단순 2배 = 기초 누적수익률×2 (가상) · '시장 2배 후 제자리 = 0'과 '하루 +10% 후 제자리 = -1.8%'는 2배 레버리지 산술 · 데이터: ETF데이터")
print("P6 완료")
