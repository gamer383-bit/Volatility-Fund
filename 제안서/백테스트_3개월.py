# -*- coding: utf-8 -*-
"""최근 6개월 급변동 구간 실측 (18페이지용) — 좌: 목표 환매 없음 / 우: +15% 재운용
- 기간: 2026-01-28 이후 첫 영업일 ~ 최신일 (기준가=직전 영업일 종가 100, 만기 1년 지평)
...
START='2026-01-28'; SIGCAP=0.60   # 최근 6개월 (직전 영업일 종가 앵커)
...
def run(target_on):
    """6개월 구간. target_on=True: 턴 내 +15% 달성 시 당일 종가 전량 청산(30bp) 후
